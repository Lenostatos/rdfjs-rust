...
impl NamedNode {
    ...
    fn to_term_type(&self) -> TermType {
        TermType::NamedNode(self.to_owned())
    }
...
impl BlankNode {
    ...
    fn to_term_type(&self) -> TermType {
        TermType::BlankNode(self.to_owned())
    }
...
impl Literal {
    ...
    fn to_term_type(&self) -> TermType {
        TermType::Literal(self.to_owned())
    }
...
impl Variable {
    ...
    fn to_term_type(&self) -> TermType {
        TermType::Variable(self.to_owned())
    }
...
impl DefaultGraph {
    ...
    fn to_term_type(&self) -> TermType {
        TermType::DefaultGraph(self.to_owned())
    }
...
fn validate_quad_predicate_type(term: &Term) {
    match term.term_type_enum {
        TermType::NamedNode(_) | TermType::Variable(_) => (),
        _ => {
...
impl Quad {
    ...
    fn to_term_type(&self) -> TermType {
        TermType::Quad(Box::new(self.to_owned()))
    }
